...
Work stopped at the owner's request on 2026-09-12. The remaining items below
...
- [ ] **Wine startup:** investigate the current whole-CRT probe's guest read violation at `0x58494e69`. It occurs after NtInitializeNlsFiles, NtGetNlsSectionPtr and NtQueryDefaultLocale; the underlying cause is not yet established. See [recorded probe](evidence/wine-crt-results.json).
...
- [ ] Build tested graphics paths for OpenGL/WGL and DirectX/WineD3D/WebGPU. These APIs do not work generally today.
...
- `npm test`: 185 passing tests at this wrap-up.
